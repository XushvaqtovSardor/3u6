...
router.post("/verifyEmail", validate(authSchemas.verifyOTP), authController.verifyOTP);
router.post("/resendEmail", validate(authSchemas.resendOTP), authController.resendOTP);
